...
/**
 * Config by Martin "Motschen" Prokoph
...
public abstract class Config {
    ...
    public static void init(String modid, Class<? extends Config> config) {
        path = NoteblockPlayer.MAIN_DIR.resolve("config.json");
    ...
    public static Config getClass(String modid) {
        try {
    ...
    public void writeChanges(String modid) {
        try {
            if (!Files.exists(path = NoteblockPlayer.MAIN_DIR.resolve("config.json")))
