...
public class Playlist {
    ...
    public static void createPlaylist(String playlist) throws IOException {
        Path playlistDir = FileUtils.resolveWithIOException(NoteblockPlayer.PLAYLISTS_DIR, playlist);
    ...
    public static void addSong(Path directory, Path songFile) throws IOException {
        ...
        Files.copy(songFile, FileUtils.resolveWithIOException(directory, songFile.getFileName().toString()));
    ...
    public static void removeSong(Path directory, String songName) throws IOException {
        ...
        Path songFile = FileUtils.resolveWithIOException(directory, songName);
        if (!Files.exists(songFile)) {
    ...
    public static String renameSong(Path directory, int pos, String newName) throws IOException {
        ...
        Path oldPath = FileUtils.resolveWithIOException(directory, index.get(pos));
        Files.move(oldPath, FileUtils.resolveWithIOException(directory, newName));
