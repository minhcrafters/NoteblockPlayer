...
public class SongItemConfirmScreen extends Screen {
    ...
    public SongItemConfirmScreen(ItemStack stack) throws IOException, IllegalArgumentException {
        super(Text.literal("Are you sure you want to play this song?"));
        this.stack = stack;
